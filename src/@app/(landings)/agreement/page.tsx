  ...
  return (
    <Container className="pt-[24px]">
      ...
      <p className="mb-[12px]">
        ...
        пользоваться платформой freelance.com («freelance.com», «Мы», «Нас», «Наш»). Заходя на
        https://freelance.com или любой другой связанный(е) сайт(ы), приложения, услуги и товары, или любой другой
        управляемый нами веб-сайт, который ссылается на это соглашение (каждый из них именуется «Сайт»), вы признаете, что
        вы прочитали и поняли настоящее Соглашение.
      </p>
